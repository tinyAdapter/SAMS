...
~/anaconda3/bin/python3 main.py \
    ...
    --dropout 0.1   \
    --K 16 --alpha 2.5 --max_filter_col 13\
    --epoch 50 --batch_size 1024 --lr 0.01 \
    --seed 3407 --beta 0.005\
    --train_dir armnet_K16_alpha2-5_beta5e-3  --report_freq 5
...
~/anaconda3/bin/python3 main.py \
    ...
    --epoch 50 --batch_size 1024 --lr 0.01 \
    --seed 3407 --beta 0.005\
    --train_dir armnet_K16_alpha2_beta5e-3_freeze_alpha  --report_freq 5
...
~/anaconda3/bin/python3 main.py \
    ...
    --hid_layer_len 32 --sql_nemb 5\
    --dropout 0.1   \
    --K 16 --alpha 1.7 --max_filter_col 13\
    --epoch 50 --batch_size 1024 --lr 0.01 \
    --seed 3407 --beta 0.005\
    --train_dir armnet_K16_alpha1-7_beta5e-3_freeze_alpha  --report_freq 5