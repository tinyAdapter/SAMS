...
~/anaconda3/bin/python3 main.py \
    ...
    --dataset credit --nfeat 350 --nfield 23 \
     ...
     --hid_layer_len 16 --sql_nemb 10\
     --dropout 0.1   \
     --K 32 --alpha 1.1 --max_filter_col 3\
     --epoch 50 --batch_size 1024 --lr 0.002 \
     --seed 3047 --beta=0.001 --gamma=0.001 \
     --train_dir dnn_K32_alpha1 --report_freq 5
...
~/anaconda3/bin/python3 main.py \
    ...
    --dataset credit --nfeat 350 --nfield 23 \
     ...
     --hid_layer_len 16 --sql_nemb 10\
     --dropout 0.1   \
     --K 64 --alpha 1.1 --max_filter_col 3\
     --epoch 50 --batch_size 1024 --lr 0.002 \
     --seed 3047 --beta=0.001 --gamma=0.001 \
     --train_dir dnn_K64_alpha1 --report_freq 5
...
~/anaconda3/bin/python3 main.py \
    ...
    --dataset credit --nfeat 350 --nfield 23 \
     ...
     --hid_layer_len 16 --sql_nemb 10\
     --dropout 0.1   \
     --K 128 --alpha 1.1 --max_filter_col 3\
     --epoch 50 --batch_size 1024 --lr 0.002 \
     --seed 3047 --beta=0.001 --gamma=0.001 \
     --train_dir dnn_K128_alpha1 --report_freq 5